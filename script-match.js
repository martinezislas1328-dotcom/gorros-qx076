...
function comprarDirecto(id, nombre, precio, imagen, tipo, categoria) {
    const telefono = "525519178328";
    let msjWa = `*TICKET DE PEDIDO - GORROS QX076*\n-----------------------------------------------\nHola, deseo procesar la siguiente compra:\n\n1x ${nombre} ... $${precio} MXN\n-----------------------------------------------\n*TOTAL A PAGAR: $${precio} MXN*\n-----------------------------------------------\n\nQuedo en espera de las instrucciones para el método de pago y el envío. Gracias.`;
    ...
    db.ref('Pedidos/' + orderId).set({
        ...
        estado: 'pendiente',
        total: precio,
        items: [{ id: id, nombre: nombre, precio: precio, cantidad: 1, tipo: tipo, categoria: categoria }]
    });
